...
struct vk_device_struct {
    ...
    vk_pipeline pipeline_argmax_ext_f32;
    vk_pipeline pipeline_topk_ext_f32;
    vk_pipeline pipeline_cross_ring_interleave_f32;
    vk_pipeline pipeline_ssm_scan_f32_d128;
    vk_pipeline pipeline_ssm_scan_f32_d256;
    vk_pipeline pipeline_ssm_conv_f32;
    vk_pipeline pipeline_ssm_conv_tree_f32;
...
struct vk_op_argmax_ext_push_constants {
    uint32_t KX;
    uint32_t KY;
    float inv_temp;
    uint32_t seed_lo;
...
struct vk_op_cross_ring_push_constants {
    uint32_t ring_size;
    uint32_t read_start;
    uint32_t cross_len;
    uint32_t n_layers;
    uint32_t n_embd;
    uint32_t layer_ring_offset;
};
...
#define CREATE_MM2(PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT) \
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_TQ3_0], matmul_tq3_0_f16, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_TURBO4_0], matmul_turbo4_0_f16, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3)
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TQ3_0], matmul_id_subgroup_tq3_0_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TURBO4_0], matmul_id_subgroup_turbo4_0_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        if (device->coopmat_acc_f16_support) {
            ...
            CREATE_MM2(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TURBO4_0], matmul_turbo4_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            ...
            CREATE_MM(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TQ3_0].f32acc, matmul_tq3_0_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TURBO4_0].f32acc, matmul_turbo4_0_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
        ...
        CREATE_MM2(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TQ3_0], matmul_id_subgroup_tq3_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
        CREATE_MM2(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TURBO4_0], matmul_id_subgroup_turbo4_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        ...
        CREATE_MM2(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TQ3_0], matmul_tq3_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM2(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TQ3_0], matmul_id_subgroup_tq3_0_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM2(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TQ3_0], matmul_id_tq3_0_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM2(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TURBO4_0], matmul_id_turbo4_0_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#define CREATE_MMQ(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        CREATE_MM(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TQ3_0].f32acc, matmul_tq3_0_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TURBO4_0].f32acc, matmul_turbo4_0_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TQ3_0].f32acc, matmul_id_subgroup_tq3_0_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TURBO4_0].f32acc, matmul_id_subgroup_turbo4_0_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TQ3_0].f32acc, matmul_id_tq3_0_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM(GGML_TYPE_TURBO4_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_TURBO4_0].f32acc, matmul_id_turbo4_0_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#undef CREATE_MM
    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_TQ3_0][i], "mul_mat_vec_tq3_0_f32_f32", arr_dmmv_tq3_0_f32_f32_len[reduc], arr_dmmv_tq3_0_f32_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {wg_size_subgroup, 1*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_TQ3_0][i], "mul_mat_vec_tq3_0_f16_f32", arr_dmmv_tq3_0_f16_f32_len[reduc], arr_dmmv_tq3_0_f16_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {wg_size_subgroup, 1*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_TQ3_0], "mul_mat_vec_id_tq3_0_f32",       arr_dmmv_id_tq3_0_f32_f32_len[reduc],    arr_dmmv_id_tq3_0_f32_f32_data[reduc],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {1*rm_stdq, 1, 1}, {wg_size_subgroup, 1*rm_stdq}, 1, true, use_subgroups, force_subgroup_size);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_TURBO4_0], "mul_mat_vec_id_turbo4_0_f32",       arr_dmmv_id_turbo4_0_f32_f32_len[reduc],    arr_dmmv_id_turbo4_0_f32_f32_data[reduc],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {1*rm_stdq, 1, 1}, {wg_size_subgroup, 1*rm_stdq}, 1, true, use_subgroups, force_subgroup_size);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_TURBO4_0], "dequant_turbo4_0", dequant_turbo4_0_len, dequant_turbo4_0_data, "main", 2, 5 * sizeof(uint32_t), {256 * 16, 1, 1}, {}, 1);
    ...
    if (device->float_controls_rte_fp16) {
        ...
        ggml_vk_create_pipeline(device, device->pipeline_cpy_f32_quant[GGML_TYPE_TURBO4_0], "cpy_f32_turbo4_0", cpy_f32_turbo4_0_rte_len, cpy_f32_turbo4_0_rte_data, "main", 2, sizeof(vk_op_unary_push_constants), {128, 1, 1}, {}, 1);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_cpy_f32_quant[GGML_TYPE_TURBO4_0], "cpy_f32_turbo4_0", cpy_f32_turbo4_0_len, cpy_f32_turbo4_0_data, "main", 2, sizeof(vk_op_unary_push_constants), {128, 1, 1}, {}, 1);
...
#define IM2COL(bda) \
...

    {
        ...
        for (uint32_t si = 0; si < 3; si++) {
            ...
            const void * gdn_data;
            if (use_subgroup_reduce && need_clustered_shader) {
                gdn_len = gated_delta_net_tree_f32_len;
                gdn_data = (const void *)gated_delta_net_tree_f32_data;
            } else if (use_subgroup_reduce) {
                gdn_len = gated_delta_net_tree_f32_nocluster_len;
                gdn_data = (const void *)gated_delta_net_tree_f32_nocluster_data;
            } else {
                gdn_len = gated_delta_net_tree_f32_shmem_len;
                gdn_data = (const void *)gated_delta_net_tree_f32_shmem_data;
            }
            ...
            for (uint32_t kda = 0; kda < 2; kda++) {
                ggml_vk_create_pipeline(device, device->pipeline_gated_delta_net_tree[si][kda],
                    gdn_tree_names[si][kda], gdn_len, gdn_data, "main", 9, sizeof(vk_op_gated_delta_net_push_constants),
                    wg_denoms, {S_V, kda, device->subgroup_size, lanes_per_column}, 1, true, use_subgroup_reduce, device->subgroup_size);
            }
        }
    }

    ggml_vk_create_pipeline(device, device->pipeline_argmax_ext_f32, "argmax_ext_f32", argmax_ext_f32_len, argmax_ext_f32_data, "main", 2, sizeof(vk_op_push_constants), {1, 1, 1}, { device->subgroup_size }, 1);
    ggml_vk_create_pipeline(device, device->pipeline_topk_ext_f32, "topk_ext_f32", topk_ext_f32_len, topk_ext_f32_data, "main", 2, sizeof(vk_op_push_constants), {1, 1, 1}, { device->subgroup_size }, 1);
    ggml_vk_create_pipeline(device, device->pipeline_cross_ring_interleave_f32, "cross_ring_interleave_f32", cross_ring_interleave_f32_len, cross_ring_interleave_f32_data, "main", 2, sizeof(vk_op_cross_ring_push_constants), {1, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_ssm_conv_tree_f32, "ssm_conv_tree_f32", ssm_conv_tree_f32_len, ssm_conv_tree_f32_data, "main", 4, sizeof(vk_op_ssm_conv_push_constants), {32, 16, 1}, {32, 16}, 1);
...
static vk_pipeline ggml_vk_op_get_pipeline(ggml_backend_vk_context * ctx, const ggml_tensor * src0, const ggml_tensor * src1, const ggml_tensor * src2, const ggml_tensor * dst, ggml_op op) {
    ...
    case GGML_OP_ARGMAX:
        if (src0->type == GGML_TYPE_F32 && dst->type == GGML_TYPE_I32) {
            ...
            if (temp > 0.0f || seed_lo != 0) {
                return ctx->device->pipeline_argmax_ext_f32;
            }
    ...
    case GGML_OP_SSM_CONV_TREE:
        if (src0->type == GGML_TYPE_F32 && dst->type == GGML_TYPE_F32) {
            return ctx->device->pipeline_ssm_conv_tree_f32;
        }
        return nullptr;
...
static void ggml_vk_argmax_ext(ggml_backend_vk_context * ctx, vk_context& subctx, const ggml_tensor * src0, ggml_tensor * dst) {
    GGML_ASSERT(dst->buffer != nullptr);
    ...
    vk_pipeline pipeline = ctx->device->pipeline_argmax_ext_f32;
    GGML_ASSERT(pipeline != nullptr);
    ...
    float seed_lo_f, seed_hi_f;
    memcpy(&seed_lo_f, &seed_lo, sizeof(float));
    memcpy(&seed_hi_f, &seed_hi, sizeof(float));
    float one_f = 1.0f;

    const vk_op_push_constants pc = {
        (uint32_t)src0->ne[0],
    ...
    ggml_vk_dispatch_pipeline(ctx, subctx, pipeline, {src_buf, dst_buf}, pc, {1, 1, (uint32_t)ggml_nrows(src0)});
}

static void ggml_vk_topk_ext(ggml_backend_vk_context * ctx, vk_context& subctx, const ggml_tensor * src0, ggml_tensor * dst) {
    GGML_ASSERT(dst->buffer != nullptr);
    ...
    vk_pipeline pipeline = ctx->device->pipeline_topk_ext_f32;
    GGML_ASSERT(pipeline != nullptr);
    ...
    float seed_lo_f, seed_hi_f, K_f;
    memcpy(&seed_lo_f, &seed_lo, sizeof(float));
    memcpy(&seed_hi_f, &seed_hi, sizeof(float));
    memcpy(&K_f, &K, sizeof(float));
...
static void ggml_vk_ssm_conv_tree(ggml_backend_vk_context * ctx, vk_context& subctx, ggml_tensor * dst) {
    ...
    ggml_vk_op_f32<vk_op_ssm_conv_push_constants>(ctx, subctx, src0, src1, src2, nullptr, dst, GGML_OP_SSM_CONV_TREE, {
        (uint32_t)src0->nb[1], (uint32_t)src0->nb[2],
        (uint32_t)src1->nb[1],
        (uint32_t)dst->nb[0], (uint32_t)dst->nb[1], (uint32_t)dst->nb[2],
        (uint32_t)src1->ne[0],
...
static bool ggml_vk_build_graph(ggml_backend_vk_context * ctx, ggml_cgraph * cgraph, int node_idx, ggml_tensor *node_begin, int node_idx_begin, bool last_node, bool almost_ready, bool submit){
    ...
    case GGML_OP_ARGMAX:
        {
            float temp = 0.0f;
            memcpy(&temp, &node->op_params[0], sizeof(float));
            uint32_t seed_lo = 0;
            memcpy(&seed_lo, &node->op_params[1], sizeof(uint32_t));
            if (temp > 0.0f || seed_lo != 0) {
                ggml_vk_argmax_ext(ctx, compute_ctx, src0, node);
            } else {
...
struct dflash_cross_ring_vk {
    ...
    int n_embd;
    int ring_size;
    vk::Buffer ring_buffer;
    vk::DeviceMemory ring_memory;
...
static vk_device vk_get_first_device() {
    for (size_t i = 0; i < GGML_VK_MAX_DEVICES; i++) {
        if (vk_instance.devices[i] != nullptr) {
            return vk_instance.devices[i];
        }
    }
    return nullptr;
}

static uint32_t vk_find_memory_type(vk_device dev, uint32_t type_filter, vk::MemoryPropertyFlags properties) {
    vk::PhysicalDeviceMemoryProperties mem_props = dev->physical_device.getMemoryProperties();
    for (uint32_t i = 0; i < mem_props.memoryTypeCount; i++) {
...
extern "C" void * dflash_cross_ring_vk_alloc(int n_layers, int n_embd, int ring_size, int device_idx) {
    ...
    ring->ring_buffer_size = (size_t)n_layers * ring_size * n_embd * sizeof(float);
    ring->staging_buffer_size = (size_t)ring_size * n_layers * n_embd * sizeof(float);
    ring->host_staging_ptr = nullptr;

    try {
        vk::BufferCreateInfo ring_buf_info({}, ring->ring_buffer_size,
            vk::BufferUsageFlagBits::eStorageBuffer | vk::BufferUsageFlagBits::eTransferDst | vk::BufferUsageFlagBits::eTransferSrc,
            vk::SharingMode::eExclusive);
        ring->ring_buffer = dev->device.createBuffer(ring_buf_info);

        vk::MemoryRequirements ring_mem_req = dev->device.getBufferMemoryRequirements(ring->ring_buffer);
        uint32_t ring_mem_type = vk_find_memory_type(dev, ring_mem_req.memoryTypeBits,
            vk::MemoryPropertyFlagBits::eDeviceLocal);
        if (ring_mem_type == UINT32_MAX) {
            dev->device.destroyBuffer(ring->ring_buffer);
            delete ring;
            return nullptr;
        }
        vk::MemoryAllocateInfo ring_alloc(ring_mem_req.size, ring_mem_type);
        ring->ring_memory = dev->device.allocateMemory(ring_alloc);
        dev->device.bindBufferMemory(ring->ring_buffer, ring->ring_memory, 0);

        vk::BufferCreateInfo staging_buf_info({}, ring->staging_buffer_size,
            vk::BufferUsageFlagBits::eStorageBuffer | vk::BufferUsageFlagBits::eTransferSrc | vk::BufferUsageFlagBits::eTransferDst,
            vk::SharingMode::eExclusive);
        ring->staging_buffer = dev->device.createBuffer(staging_buf_info);

        vk::MemoryRequirements staging_mem_req = dev->device.getBufferMemoryRequirements(ring->staging_buffer);
        uint32_t staging_mem_type = vk_find_memory_type(dev, staging_mem_req.memoryTypeBits,
            vk::MemoryPropertyFlagBits::eDeviceLocal);
        if (staging_mem_type == UINT32_MAX) {
            dev->device.destroyBuffer(ring->staging_buffer);
            dev->device.freeMemory(ring->ring_memory);
            dev->device.destroyBuffer(ring->ring_buffer);
            delete ring;
            return nullptr;
        }
        vk::MemoryAllocateInfo staging_alloc(staging_mem_req.size, staging_mem_type);
        ring->staging_memory = dev->device.allocateMemory(staging_alloc);
        dev->device.bindBufferMemory(ring->staging_buffer, ring->staging_memory, 0);

        size_t host_staging_size = (size_t)ring_size * n_layers * n_embd * sizeof(float);
        vk::BufferCreateInfo host_buf_info({}, host_staging_size,
            vk::BufferUsageFlagBits::eTransferSrc | vk::BufferUsageFlagBits::eTransferDst,
            vk::SharingMode::eExclusive);
        ring->host_staging_buffer = dev->device.createBuffer(host_buf_info);

        vk::MemoryRequirements host_mem_req = dev->device.getBufferMemoryRequirements(ring->host_staging_buffer);
        uint32_t host_mem_type = vk_find_memory_type(dev, host_mem_req.memoryTypeBits,
            vk::MemoryPropertyFlagBits::eHostVisible | vk::MemoryPropertyFlagBits::eHostCoherent);
        if (host_mem_type == UINT32_MAX) {
            dev->device.destroyBuffer(ring->host_staging_buffer);
            dev->device.destroyBuffer(ring->staging_buffer);
            dev->device.freeMemory(ring->staging_memory);
            dev->device.freeMemory(ring->ring_memory);
            dev->device.destroyBuffer(ring->ring_buffer);
            delete ring;
            return nullptr;
        }
        vk::MemoryAllocateInfo host_alloc(host_mem_req.size, host_mem_type);
        ring->host_staging_memory = dev->device.allocateMemory(host_alloc);
        ...
        fprintf(stderr, "dflash vk ring: allocation failed: %s\n", e.what());
        delete ring;
        return nullptr;
    }
...
extern "C" void dflash_cross_ring_vk_free(void * handle) {
    if (!handle) return;
    ...
    ring->vkdev.freeMemory(ring->staging_memory);
    ring->vkdev.destroyBuffer(ring->staging_buffer);
    ring->vkdev.freeMemory(ring->ring_memory);
    ring->vkdev.destroyBuffer(ring->ring_buffer);
    delete ring;
}

extern "C" void dflash_cross_ring_vk_write(void * handle, int layer, int ring_pos,
    ...
    size_t upload_size = (size_t)n_tokens * n_embd * sizeof(float);
...
static void ggml_vk_check_results_0(ggml_backend_vk_context * ctx, ggml_cgraph * cgraph, int tensor_idx) {
    ...
    for (int f = 0; f < ctx->num_additional_fused_ops + 1; ++f) {
        ...
        if (tensor->op == GGML_OP_FLASH_ATTN_EXT) {
            ...
            tensor_clone = ggml_gated_delta_net_tree(ggml_ctx, src_clone[0], src_clone[1],
            src_clone[2], src_clone[3], src_clone[4], src_clone[5], src_clone[6], src_clone[7]);
            ...
            tensor_clone = ggml_ssm_conv_tree(ggml_ctx, src_clone[0], src_clone[1], src_clone[2]);
